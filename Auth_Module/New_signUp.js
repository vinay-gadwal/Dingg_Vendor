...
export default class example extends Component {
  ...
  _getCode = async () => {
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        const res=  fetch('http://18.217.123.119:3000/api/vendor_signup', {
      method: 'POST',
      body: JSON.stringify({
        ...this.refs.form.getValues(),
        // ...this.state.country,
        "mobile": this.state.enterCode,
      })
})
  ...
  //       const res = await api.post('http://18.217.123.119:3000/api/vendor_signup', {
  //         body: {
  //           ...this.refs.form.getValues(),
  //           ...this.state.country
  //         }
  ...
  _verifyCode = () => {
    ...
    setTimeout(async () => {
      ...
      try {
        ...
        const res = fetch('http://18.217.123.119:3000/api/vendor_verify_account', {
          method: 'POST', 
        body: {
            ...this.refs.form.getValues(),
            ...this.state.country
        ...
        this.setState({ spinner: false });
        setTimeout(() => {
          Alert.alert('Oops! cbxhjchj', err.message);
        }, 100);
      }
  ...
  render() {
    ...
    let headerText = `Enter ${this.state.enterCode ? 'OTP sent' : 'the registered mobile number'}?`
...
<View style={{paddingVertical:hp("2%")}}>
        ...
        <Form ref={'form'} style={styles.form}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <TextInput
              ...
              placeholder={this.state.enterCode ? '_  _  _  _' : 'Enter Mobile Number'}
        ...
        <TouchableOpacity onPress={this._getSubmitAction} style={[styles.button,{width: wp('40'),marginVertical:hp("3%")}]}>
